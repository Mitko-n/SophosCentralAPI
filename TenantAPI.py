...
class Tenant:
    ...
    def _request(self, method, endpoint, **kwargs):
        if self._session is None:
            return {"status": "error", "message": "Session is closed.", "data": "Session is closed."}
        ...
        try:
            ...
            if response.ok:
                return {"status": "success", "message": "Request successful", "data": response.json()}
            else:
                return {"status": "error", "message": "Request failed", "data": f"Request failed with status code {response.status_code}"}
        except requests.RequestException as e:
            return {"status": "error", "message": "Request exception occurred.", "data": str(e)}
